local locales = {
  ...
  ["trTR"] = {
    ["Alliance"] = "İttifak",
    ["All Quests"] = "Tüm Görevler",
    ["and"] = "ve",
    ["Area/Zone"] = "Bölge/Alan",
    ["Buy"] = "Satın Al",
    ["|cff33ffcc<Click>|r Unfold/Fold Objectives\n|cff33ffcc<Right-Click>|r Show In QuestLog\n|cff33ffcc<Ctrl-Click>|r Show Map / Toggle Color\n|cff33ffcc<Shift-Click>|r Hide Nodes"] = "|cff33ffcc<Tıkla>|r Amaçları Aç/Kapat\n|cff33ffcc<Sağ Tık>|r Görev Günlüğünde Göster\n|cff33ffcc<Ctrl-Tık>|r Haritayı Göster / Rengi Değiştir\n|cff33ffcc<Shift-Tık>|r Noktaları Gizle",
    ["|cff33ffcc<Ctrl-Click>|r Show Map / Toggle Color\n|cff33ffcc<Shift-Click>|r Hide Nodes"] = "|cff33ffcc<Ctrl-Tık>|r Haritayı Göster / Rengi Değiştir\n|cff33ffcc<Shift-Tık>|r Noktaları Gizle",
    ["|cff33ffcc<Ctrl-Click>|r Show Map / Toggle Color\n|cff33ffcc<Shift-Click>|r Mark As Done"] = "|cff33ffcc<Ctrl-Tık>|r Haritayı Göster / Rengi Değiştir\n|cff33ffcc<Shift-Tık>|r Tamamlandı Olarak İşaretle",
    ["|cff33ffccpf|cffffffffQuest: Tracker is now hidden. Type `/db tracker` to show."] = "|cff33ffccpf|cffffffffQuest: Takipçi gizlendi. Göstermek için `/db tracker` yazın.",
    ["|cff33ffccpf|rQuest: New version available! Have a look at http://shagu.org !"] = "|cff33ffccpf|rQuest: Yeni versiyon mevcut! http://shagu.org adresine göz atın!",
    ["Clean"] = "Temizle",
    ["Clean Database Results"] = "Veritabanı Sonuçlarını Temizle",
    ["Clean Map"] = "Haritayı Temizle",
    ["Click Node To Change Color"] = "Rengi Değiştirmek İçin Noktaya Tıklayın",
    ["Close"] = "Kapat",
    ["Close & Reload"] = "Kapat ve Yeniden Yükle",
    ["Close Tracker"] = "Takipçiyi Kapat",
    ["Color Map Nodes By Spawn"] = "Harita Noktalarını Belirme Yerine Göre Renklendir",
    ["Combined"] = "Birleşik",
    ["Completed Level"] = "Tamamlanan Seviye",
    ["Config"] = "Ayarlar",
    ["custom items loaded."] = "özel eşyalar yüklendi.",
    ["Display addon locales"] = "Eklenti dillerini göster",
    ["Display all spawn points of each quest objective and hide summarized cluster icons."] = "Her görev amacının tüm belirme noktalarını göster ve özetlenmiş küme simgelerini gizle.",
    ["Display Available Quest Givers"] = "Mevcut Görev Verenleri Göster",
    ["Display Current Quest Givers"] = "Aktif Görev Verenleri Göster",
    ["Display Event & Daily Quests"] = "Etkinlik ve Günlük Görevleri Göster",
    ["Display Level+3 Quest Givers"] = "Seviye+3 Görev Verenleri Göster",
    ["Display Low Level Quest Givers"] = "Düşük Seviye Görev Verenleri Göster",
    ["Display related creatures and NPCs"] = "İlgili yaratıkları ve NPC'leri göster",
    ["Display related items"] = "İlgili eşyaları göster",
    ["Display related objects like ores, herbs, chests, etc."] = "Madenler, bitkiler, sandıklar vb. ilgili nesneleri göster",
    ["Display related quests"] = "İlgili görevleri göster",
    ["Distance"] = "Mesafe",
    ["Do you really want to reset everything?"] = "Her şeyi gerçekten sıfırlamak istiyor musunuz?",
    ["Do you really want to reset the caches?"] = "Önbellekleri gerçekten sıfırlamak istiyor musunuz?",
    ["Do you really want to reset the configuration?"] = "Ayarları gerçekten sıfırlamak istiyor musunuz?",
    ["Do you really want to reset the quest history?"] = "Görev geçmişini gerçekten sıfırlamak istiyor musunuz?",
    ["Draw Favorites On Login"] = "Girişte Favorileri Göster",
    ["Enable Minimap Button"] = "Minimap Butonunu Etkinleştir",
    ["Enable Minimap Nodes"] = "Minimap Noktalarını Etkinleştir",
    ["Enable Quest Link Support"] = "Görev Bağlantısı Desteğini Etkinleştir",
    ["Enable Quest Log Buttons"] = "Görev Günlüğü Butonlarını Etkinleştir",
    ["Enable Quest Tracker"] = "Görev Takipçisini Etkinleştir",
    ["Enable World Map Menu"] = "Dünya Haritası Menüsünü Etkinleştir",
    ["Exploration Mark"] = "Keşif İşareti",
    ["Explore"] = "Keşfet",
    ["Explore |cff33ffcc%s|r"] = "Keşfet: |cff33ffcc%s|r",
    ["Friendly"] = "Dost",
    ["General"] = "Genel",
    ["Herbalism"] = "Bitkicilik",
    ["Hide"] = "Gizle",
    ["Hide browser window"] = "Tarayıcı penceresini gizle",
    ["Hide Quests"] = "Görevleri Gizle",
    ["Highlight Nodes On Mouseover"] = "Fareyle Üzerine Gelindiğinde Noktaları Vurgula",
    ["Hold <Ctrl> To Hide Cluster"] = "Kümeyi Gizlemek İçin <Ctrl> Tuşuna Basılı Tutun",
    ["Hold <Ctrl> To Hide Minimap Nodes"] = "Minimap Noktalarını Gizlemek İçin <Ctrl> Tuşuna Basılı Tutun",
    ["Horde"] = "Horde",
    ["Hostile"] = "Düşman",
    ["Include Quest Enders"] = "Görev Bitirenleri Dahil Et",
    ["Include Quest Starters"] = "Görev Başlatanları Dahil Et",
    ["Include Unified Quest Locations"] = "Birleştirilmiş Görev Konumlarını Dahil Et",
    ["Interact with |cff33ffcc%s|r"] = "|cff33ffcc%s|r ile etkileşime geç",
    ["Interact with |cff33ffcc%s|r to complete |cffffcc00[?]|cff33ffcc %s|r"] = "|cff33ffcc%s|r ile etkileşime geçerek şunu tamamla: |cffffcc00[?]|cff33ffcc %s|r",
    ["Interact with |cff33ffcc%s|r to obtain |cffffcc00[!]|cff33ffcc %s|r"] = "|cff33ffcc%s|r ile etkileşime geçerek şunu elde et: |cffffcc00[!]|cff33ffcc %s|r",
    ["Items"] = "Eşyalar",
    ["Journal"] = "Günlük",
    ["Kill |cff33ffcc%s|r"] = "|cff33ffcc%s|r öldür",
    ["Left-Click"] = "Sol Tık",
    ["Level"] = "Seviye",
    ["Locales"] = "Diller",
    ["Location"] = "Konum",
    ["Loot"] = "Ganimet",
    ["Loot and/or Use |cff33ffcc[%s]|r from |cff33ffcc%s|r"] = "|cff33ffcc%s|r üzerinden |cff33ffcc[%s]|r yağmala ve/veya kullan",
    ["Loot |cff33ffcc[%s]|r from |cff33ffcc%s|r"] = "|cff33ffcc%s|r üzerinden |cff33ffcc[%s]|r yağmala",
    ["Looted from"] = "Şundan yağmalanır:",
    ["Manual Selection"] = "Manuel Seçim",
    ["Map & Minimap"] = "Harita & Minimap",
    ["Minimap Node Transparency"] = "Minimap Nokta Saydamlığı",
    ["Minimum Item Drop Chance"] = "Minimum Eşya Düşme Şansı",
    ["Mining"] = "Madencilik",
    ["Move Button"] = "Butonu Taşı",
    ["N/A"] = "Mevcut Değil",
    ["Navigation Arrow"] = "Navigasyon Oku",
    ["Node Fade Transparency"] = "Nokta Solma Saydamlığı",
    ["Object"] = "Nesne",
    ["Objects"] = "Nesneler",
    ["Online Search"] = "Çevrimiçi Arama",
    ["Only show cluster icons with summarized objective locations based on spawn points"] = "Yalnızca belirme noktalarına göre özetlenmiş amaç konumlarını içeren küme simgelerini göster",
    ["Open Browser"] = "Tarayıcıyı Aç",
    ["Open Configuration"] = "Ayarları Aç",
    ["Open Database Browser"] = "Veritabanı Tarayıcısını Aç",
    ["Open Settings"] = "Ayarları Aç",
    ["others"] = "diğerleri",
    ["Please select your preferred |cff33ffccpf|cffffffffQuest|r mode:"] = "Lütfen tercih ettiğiniz |cff33ffccpf|cffffffffQuest|r modunu seçin:",
    ["Query the server for completed quests"] = "Tamamlanan görevler için sunucuyu sorgula",
    ["Quest End"] = "Görev Sonu",
    ["Quest history migration completed."] = "Görev geçmişi taşıma işlemi tamamlandı.",
    ["Questing"] = "Görev Yapma",
    ["Quest Level"] = "Görev Seviyesi",
    ["Quest Objective Icons (Mini Map)"] = "Görev Amacı Simgeleri (Minimap)",
    ["Quest Objective Icons (World Map)"] = "Görev Amacı Simgeleri (Dünya Haritası)",
    ["Quest Objective Spawn Points (Mini Map)"] = "Görev Amacı Belirme Noktaları (Minimap)",
    ["Quest Objective Spawn Points (World Map)"] = "Görev Amacı Belirme Noktaları (Dünya Haritası)",
    ["Quests"] = "Görevler",
    ["Quest Start"] = "Görev Başlangıcı",
    ["Quest Tracker Font Size"] = "Görev Takipçisi Yazı Boyutu",
    ["Quest Tracker Unfold Objectives"] = "Görev Takipçisi Amaçları Aç",
    ["Quest Tracker Visibility"] = "Görev Takipçisi Görünürlüğü",
    ["Reaction"] = "Tepki",
    ["Remove all manually searched objects from the map"] = "Manuel olarak aranan tüm nesneleri haritadan kaldır",
    ["Required"] = "Gerekli",
    ["Required Level"] = "Gerekli Seviye",
    ["Reset"] = "Sıfırla",
    ["Reset Cache"] = "Önbelleği Sıfırla",
    ["Reset Configuration"] = "Ayarları Sıfırla",
    ["Reset Everything"] = "Her Şeyi Sıfırla",
    ["Reset Language"] = "Dili Sıfırla",
    ["Reset Map"] = "Haritayı Sıfırla",
    ["Reset Quest History"] = "Görev Geçmişini Sıfırla",
    ["Respawn"] = "Yeniden Belirme",
    ["Right-Click"] = "Sağ Tık",
    ["Routes"] = "Rotalar",
    ["Scanning server for items..."] = "Sunucuda eşyalar taranıyor...",
    ["Scan the server for custom items"] = "Özel eşyalar için sunucuyu tara",
    ["Search"] = "Ara",
    ["Search item vendors"] = "Eşya satıcılarını ara",
    ["Search loot"] = "Ganimet ara",
    ["Search object"] = "Nesne ara",
    ["Search unit"] = "Birim ara",
    ["Server scan started..."] = "Sunucu taraması başlatıldı...",
    ["Shift-Click"] = "Shift-Tık",
    ["Show"] = "Göster",
    ["Show all chests on map"] = "Haritadaki tüm sandıkları göster",
    ["Show all quests on map"] = "Haritadaki tüm görevleri göster",
    ["Show all rare mobs of Level [min] to [max]"] = "[min] ile [max] Seviye arasındaki tüm nadir yaratıkları göster",
    ["Show all taxi nodes of [faction]"] = "[faction] için tüm uçuş noktalarını göster",
    ["Show Arrow Along Routes"] = "Rotalar Boyunca Oku Göster",
    ["Show cluster icons with summarized locations and also display all spawn points of each quest objective"] = "Özetlenmiş konumları içeren küme simgelerini göster ve ayrıca her görev amacının tüm belirme noktalarını görüntüle",
    ["Show configuration interface"] = "Ayarlar arayüzünü göster",
    ["Show Current Quests"] = "Mevcut Görevleri Göster",
    ["Show Database IDs"] = "Veritabanı Kimliklerini (ID) Göster",
    ["Show database interface"] = "Veritabanı arayüzünü göster",
    ["Show Database Results"] = "Veritabanı Sonuçlarını Göster",
    ["Show Help On Tooltips"] = "İpuçlarında Yardımı Göster",
    ["Show herbs with an appropriate skill level for your character"] = "Karakteriniz için uygun yetenek seviyesindeki bitkileri göster",
    ["Show herbs with skill range of [min] to [max]"] = "[min] ile [max] yetenek aralığındaki bitkileri göster",
    ["Show Level On Quest Log"] = "Görev Günlüğünde Seviyeyi Göster",
    ["Show Level On Quest Tracker"] = "Görev Takipçisinde Seviyeyi Göster",
    ["Show map tracker"] = "Harita takipçisini göster",
    ["Show mines with an appropriate skill level for your character"] = "Karakteriniz için uygun yetenek seviyesindeki madenleri göster",
    ["Show mines with skill range of [min] to [max]"] = "[min] ile [max] yetenek aralığındaki madenleri göster",
    ["Show Navigation Arrow"] = "Navigasyon Okunu Göster",
    ["Show navigation arrow that points you to the nearest quest location."] = "Sizi en yakın görev konumuna yönlendiren navigasyon okunu gösterir.",
    ["Show quest arrow"] = "Görev okunu göster",
    ["Show Quest Givers"] = "Görev Verenleri Göster",
    ["Show quest journal"] = "Görev günlüğünü göster",
    ["Show Route Between Objects"] = "Nesneler Arasındaki Rotayı Göster",
    ["Show Route On Minimap"] = "Minimap üzerinde Rotayı Göster",
    ["Show specific quest"] = "Belirli görevi göster",
    ["Show Tooltips"] = "İpuçlarını Göster",
    ["Simple Markers"] = "Basit İşaretçiler",
    ["Sold by"] = "Şunun tarafından satılır:",
    ["Spawn Points"] = "Belirme Noktaları",
    ["Speak with |cff33ffcc%s|r to complete |cffffcc00[?]|cff33ffcc %s|r"] = "Şunu tamamlamak için |cff33ffcc%s|r ile konuş: |cffffcc00[?]|cff33ffcc %s|r",
    ["Speak with |cff33ffcc%s|r to obtain |cffffcc00[!]|cff33ffcc %s|r"] = "Şunu almak için |cff33ffcc%s|r ile konuş: |cffffcc00[!]|cff33ffcc %s|r",
    ["Talk to |cff33ffcc%s|r"] = "|cff33ffcc%s|r ile konuş",
    ["Toggle completed quest browser"] = "Tamamlanan görev tarayıcısını aç/kapat",
    ["Too many entries. Results shown"] = "Çok fazla giriş var. Gösterilen sonuçlar",
    ...
    ["Unit"] = "Birim",
    ["Units"] = "Birimler",
    ["Use |cff33ffcc%s|r at |cff33ffcc%s|r"] = "|cff33ffcc%s|r nesnesini şurada kullan: |cff33ffcc%s|r",
    ["Use |cff33ffcc%s|r on |cff33ffcc%s|r"] = "|cff33ffcc%s|r nesnesini şunun üzerinde kullan: |cff33ffcc%s|r",
    ["Use Cut-Out Minimap Node Icons"] = "Kesilmiş Minimap Nokta Simgelerini Kullan",
    ["Use Cut-Out World Map Node Icons"] = "Kesilmiş Dünya Haritası Nokta Simgelerini Kullan",
    ["Use Monochrome Cluster Icons"] = "Monokrom Küme Simgelerini Kullan",
    ["Use Quest Item at |cff33ffcc%s|r"] = "Görev Eşyasını şurada kullan: |cff33ffcc%s|r",
    ["User Data"] = "Kullanıcı Verileri",
    ["Use <Shift>-Click To Mark Quest As Done"] = "Görevi Bitti Olarak İşaretlemek İçin <Shift>-Tık Kullanın",
    ["Use <Shift>-Click To Remove Nodes"] = "Noktaları Kaldırmak İçin <Shift>-Tık Kullanın",
    ["Vendor"] = "Satıcı",
    ["World Map Node Transparency"] = "Dünya Haritası Nokta Saydamlığı",
    ["You already did this quest."] = "Bu görevi zaten yaptınız.",
    ["You are on this quest."] = "Bu görevdesiniz.",
    ["You don't have this quest."] = "Bu göreve sahip değilsiniz.",
  },
}
